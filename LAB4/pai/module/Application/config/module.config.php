...
return [
    'router' => [
        'routes' => [
            ...
            'autorzy' => [ //analogicznie jak ksiazki
                'type' => Segment::class,
                'options' => [
    ...
    'controllers' => [
        'factories' => [
            ...
            AutorzyController::class => AutorzyControllerFactory::class,//dodano kontroler do fabryki autorzy
        ],
    ],
    'service_manager' => [
        'factories' => [
            ...
            AutorForm::class => ReflectionBasedAbstractFactory::class,//dodano refleksje jak dla ksiazek
        ],
    ],
    'view_manager' => [
