...
return [
    'paginators' => [
        'aliases' => [
            'dbselect' => 'Laminas\\Paginator\\Adapter\\LaminasDb\\DbSelect',
            'dbSelect' => 'Laminas\\Paginator\\Adapter\\LaminasDb\\DbSelect',
            'DbSelect' => 'Laminas\\Paginator\\Adapter\\LaminasDb\\DbSelect',
            'dbtablegateway' => 'Laminas\\Paginator\\Adapter\\LaminasDb\\DbTableGateway',
            'dbTableGateway' => 'Laminas\\Paginator\\Adapter\\LaminasDb\\DbTableGateway',
            'DbTableGateway' => 'Laminas\\Paginator\\Adapter\\LaminasDb\\DbTableGateway'
        ],
        'factories' => [
            'Laminas\\Paginator\\Adapter\\LaminasDb\\DbSelect' => 'Laminas\\Paginator\\Adapter\\LaminasDb\\DbSelectFactory',
            'Laminas\\Paginator\\Adapter\\LaminasDb\\DbTableGateway' => 'Laminas\\Paginator\\Adapter\\LaminasDb\\DbTableGatewayFactory'
        ]
    ],
    'service_manager' => [
        'aliases' => [
        ...
        'factories' => [
            ...
            'Application\\Model\\Data' => 'Laminas\\ServiceManager\\Factory\\InvokableFactory',
            'Application\\Model\\Ksiazka' => 'Laminas\\ServiceManager\\Factory\\InvokableFactory',
            'Application\\Model\\Autor' => 'Laminas\\ServiceManager\\Factory\\InvokableFactory',
            'Application\\Form\\KsiazkaForm' => 'Laminas\\ServiceManager\\AbstractFactory\\ReflectionBasedAbstractFactory',
            'navigation' => 'Laminas\\Navigation\\Service\\DefaultNavigationFactory',
            'Nieruchomosci\\Model\\Oferta' => 'Laminas\\ServiceManager\\AbstractFactory\\ReflectionBasedAbstractFactory',
            'Nieruchomosci\\Model\\Koszyk' => 'Laminas\\ServiceManager\\AbstractFactory\\ReflectionBasedAbstractFactory'
        ],
        'abstract_factories' => [
    ...
    'view_helpers' => [
        ...
        'factories' => [
            ...
            'TwbsHelper\\Form\\View\\Helper\\Form' => 'TwbsHelper\\Form\\View\\Helper\\Factory\\FormModuleOptionsFactory',
            'TwbsHelper\\Form\\View\\Helper\\FormElement' => 'TwbsHelper\\Form\\View\\Helper\\Factory\\FormModuleOptionsFactory',
            'TwbsHelper\\Form\\View\\Helper\\FormRow' => 'TwbsHelper\\Form\\View\\Helper\\Factory\\FormModuleOptionsFactory',
            'TwbsHelper\\Form\\View\\Helper\\FormCollection' => 'TwbsHelper\\Form\\View\\Helper\\Factory\\FormModuleOptionsFactory'
        ],
        'invokables' => [
            ...
            'progressBarGroup' => 'TwbsHelper\\View\\Helper\\ProgressBarGroup',
            'spinner' => 'TwbsHelper\\View\\Helper\\Spinner',
            'toast' => 'TwbsHelper\\View\\Helper\\Toast',
        ...
        'routes' => [
            ...
            'ksiazki' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => 'Application\\Controller\\KsiazkiController',
                        'action' => 'lista'
                    ]
                ]
            ],
            'nieruchomosci' => [
                ...
                'options' => [
                    'route' => '/',
                    'defaults' => [
                        'controller' => 'Nieruchomosci\\Controller\\OfertyController',
                        'action' => 'lista'
                    ]
                ],
                'may_terminate' => true,
                'child_routes' => [
                    ...
                    'koszyk' => [
                        ...
                        'options' => [
                            ...
                            'defaults' => [
                                'controller' => 'Nieruchomosci\\Controller\\KoszykController',
                                'action' => 'lista'
                            ]
                        ]
                    ]
    ...
    'navigation_helpers' => [
        'invokables' => [
            ...
            'laminasviewhelpernavigationbreadcrumbs' => 'TwbsHelper\\View\\Helper\\Navigation\\Breadcrumbs',
            'menu' => 'TwbsHelper\\View\\Helper\\Navigation\\Menu',
            'laminasviewhelpernavigationmenu' => 'TwbsHelper\\View\\Helper\\Navigation\\Menu',
            'navbar' => 'TwbsHelper\\View\\Helper\\Navigation\\Navbar',
            'laminasviewhelpernavigationnavbar' => 'TwbsHelper\\View\\Helper\\Navigation\\Navbar'
        ]
    ],
    'view_manager' => [
        'template_map' => [
            'TwbsHelper/pagination_control' => 'C:\\xampp\\htdocs\\pai\\vendor\\neilime\\twbs-helper-module\\config/../view/partial/twbsPaginationControl.phtml',
            'layout/layout' => 'C:\\xampp\\htdocs\\pai\\module\\Application\\config/../view/layout/layout.phtml',
            'application/index/index' => 'C:\\xampp\\htdocs\\pai\\module\\Application\\config/../view/application/index/index.phtml',
            'error/404' => 'C:\\xampp\\htdocs\\pai\\module\\Application\\config/../view/error/404.phtml',
            'error/index' => 'C:\\xampp\\htdocs\\pai\\module\\Application\\config/../view/error/index.phtml',
            'layout/nieruchomosci' => 'C:\\xampp\\htdocs\\pai\\module\\Nieruchomosci\\config/../view/layout/nieruchomosci.phtml',
            'menu' => 'C:\\xampp\\htdocs\\pai\\module\\Nieruchomosci\\config/../view/partial/menu.phtml'
        ],
        ...
        'template_path_stack' => [
            'C:\\xampp\\htdocs\\pai\\module\\Application\\config/../view',
            'C:\\xampp\\htdocs\\pai\\module\\Nieruchomosci\\config/../view'
        ]
    ],
    'controllers' => [
        'factories' => [
            'Application\\Controller\\IndexController' => 'Laminas\\Mvc\\Controller\\LazyControllerAbstractFactory',
            'Application\\Controller\\KsiazkiController' => 'Application\\Controller\\KsiazkiControllerFactory',
            'Nieruchomosci\\Controller\\OfertyController' => 'Laminas\\Mvc\\Controller\\LazyControllerAbstractFactory',
            'Nieruchomosci\\Controller\\KoszykController' => 'Laminas\\Mvc\\Controller\\LazyControllerAbstractFactory'
        ]
    ],
    'navigation' => [
        'default' => [
